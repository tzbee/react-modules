...
var ResultList = React.createClass({displayName: "ResultList",
	render: function() {
		return React.createElement("ul", null, this.props.results.map(function(result, index) {
...
var SearchWrapper = React.createClass({displayName: "SearchWrapper",
	...
	render: function() {
		return 	React.createElement("div", {className: "searchWrapper"}, 
					...
					this.state.loading ? React.createElement(Loader, null) : React.createElement(ResultList, {results: this.state.results})
				);
	}
});