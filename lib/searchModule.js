		...
		return React.createElement("div", {
			...
			React.createElement("form", {
				...
				React.createElement(TextInput, {
					handleChange: this.onKeywordChange,
					className: "keyword"
				}),
				React.createElement(TextInput, {
					handleChange: this.onEngineChange,
					className: "engine"
				}),
...
var ResultList = React.createClass({
	...
	render: function() {
		return React.createElement("div", {
			className: "resultBox"
		}, React.createElement("ul", null, this.props.results.map(function(result, index) {
...
var Loader = React.createClass({
	...
	componentDidMount: function() {
		this.props.refreshIntervalId = setInterval(function() {
			this.setState({
				threeDots: !this.state.threeDots
			});
		}.bind(this), 500);
	},
...
var SearchWrapper = React.createClass({
	...
	render: function() {
		return React.createElement("div", {
			...
			this.state.loading ? React.createElement(Loader, null) : this.state.error.status ? React.createElement(Error, {
